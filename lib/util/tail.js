            ...
            if (watchersArr.length > 0) {
                ...
                _.each(watchersArr, function (watcher) {
                    promiseArr.push(new Promise(function (resolve, reject) {
                        ...
                        return Crud.insert(watcher.Content.elasticsearch.elasticsearch_index, watcher.Content.elasticsearch.elasticsearch_type, doc.o._id.toString(), opDoc, watcher.Content.elasticsearch.elasticsearch_url).then(function (result) {
                ...
                _.each(watchersArr, function (watcher) {
                    promiseArr.push(new Promise(function (resolve, reject) {
                        ...
                        if (Util.filterJson(watcher.Content.mongodb.mongodb_filterQueryFilds, doc.o)) {
                            return Crud.update(watcher.Content.elasticsearch.elasticsearch_index, watcher.Content.elasticsearch.elasticsearch_type, doc.o2._id.toString(), opDoc, watcher.Content.elasticsearch.elasticsearch_url).then(function (result) {
                                return resolve(result);
                            }).catch(function (err) {
                                return reject(err);
                            });
                            ...
                            return Crud.remove(watcher.Content.elasticsearch.elasticsearch_index, watcher.Content.elasticsearch.elasticsearch_type, doc.o._id.toString(), watcher.Content.elasticsearch.elasticsearch_url).then(function (result) {
                                return resolve(result);
                            }).catch(function (err) {
                                return reject(err);
                            });
