 ...
 * @Last Modified time: 2018-07-20 10:57:44
    ...
    return {
        getConnection: function getConnection(connectionString, httpAuth) {
            return new Promise(function (resolve, reject) {
                ...
                var connectionStringArray = connectionString.split(":");
                ElasticSearchConfig.host = {
                    protocol: connectionStringArray[0],
                    host: connectionStringArray[1].split("/")[2],
                    port: connectionStringArray[2].split("/")[0],
                    headers: {
                        'Content-Encoding': 'gzip,deflate'
                    }
                };
                ElasticSearchConfig.requestTimeout = 120000;
                ElasticSearchConfig.deadTimeout = 120000;
